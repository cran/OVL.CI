#' @title OVL.LogitDBC
#' @description Parametric approach using the delta method after the Box-Cox transformation after switching to a logit scale and then transforming back
#' @param x controls
#' @param y cases
...
OVL.LogitDBC<-function(x,y,alpha=0.05,h_ini=-0.6){
x_aux<-x
y_aux<-y
