#' @title OVL.LogitDBCL
#' @description Parametric approach using the delta method after the Box-Cox transformation in the logit scale and back-transformed considering the variability of the estimated transformation parameter
#' @param x controls
#' @param y cases
...
OVL.LogitDBCL<-function(x,y,alpha=0.05,h_ini=-0.6){
x_aux<-x
y_aux<-y
